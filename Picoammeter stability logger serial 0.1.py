...
with serial.Serial('COM%i'%com_port, baudrate=9600, timeout=0.1) as kly:
    ...
    kly.write(b'CURR:NPLC %i\r'%sensitivity) #6 = high at 60 Hz
    ...
    def request_data():
        ...
        while True:
            ...
            if response == b'':
                ...
                return response.decode("UTF-8")*current_multiplier
